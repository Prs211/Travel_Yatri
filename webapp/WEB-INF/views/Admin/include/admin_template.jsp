...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand" href="<spring:url value='/Admin/Dashboard'/>">Travel Yatri</a>
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Dashboard">
          <a class="nav-link" href="<spring:url value='/Admin/Dashboard'/>">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="layout">
          <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#layout" data-parent="#exampleAccordion">
            ...
            <li>  
              <a href="<spring:url value='/Admin/viewPackages'/>"> <i class="fa fa-fw fa-link"></i> View Packages</a>
            </li>
            <li>
              <a href="<spring:url value='/Admin/addPackages'/>"><i class="fa fa-fw fa-link"></i>Add Packages</a>
            </li>
              <li>  
              <a href="<spring:url value='/Admin/addImages'/>"> <i class="fa fa-fw fa-link"></i> Add Images</a>
            </li>
            <li>
              <a href="<spring:url value='/Admin/contactUs'/>"><i class="fa fa-fw fa-link"></i>Contact Us</a>
            </li>
          </ul>
        </li>
         <li class="nav-item" data-toggle="tooltip" data-placement="right" title="vendor">
          <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#vendor" data-parent="#exampleAccordion">
            ...
            <span class="nav-link-text">Bookings & Review</span>
          </a>
            <ul class="sidenav-second-level collapse" id="vendor">
            <li>  
              <a href="<spring:url value='/Admin/watchBookings'/>">  <i class="fa fa-fw fa-file"></i> Watch Bookings</a>
            </li>
           <%--  <li>
              <a href="<spring:url value='/Admin/userFeedback'/>"><i class="fa fa-fw fa-file"></i>User Feedback</a>
            </li> --%>
