...
<body>
	...
	<header>
		...
		<nav class="navbar">
			<a href='<spring:url value="/"/>'>home</a> <a href="#book">book</a> <a href="#packages">packages</a>
	...
	<div class="wrapper">
		...
		<form class="form-right" action='<spring:url value="/User/bookSeat"/>'
			method="post">
			<h2 class="text-uppercase">Travel Yatri Package Booking Form</h2>
			<h2 style="color: red">${requestScope.message}</h2>
			<div class="row">
				<div class="col-sm-6 mb-3">
					<label>Package </label> <input
						value="${sessionScope.package1.title}" type="text"
						name="package" class="input-field" readonly>
				</div>
				
			</div>
			<div class="mb-3">
				<label>Start Date</label> <input type="date" class="input-field"
					name="sdate" required>
			</div>
			<div class="mb-3">
				<label>End Date</label> <input type="date" class="input-field"
					name="edate" required>
			</div>
			<div class="row">
				<div class="col-sm-6 mb-3">
					<label>Payment Type</label> <select type="text" name="ptype"
						class="input-field">
