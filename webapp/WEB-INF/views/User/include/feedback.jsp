	...
	<div class="container-fluid">
		...
		<div class="container mt-3">
			<div class="container" style="margin-top: 50px;">
				<form method="post" action='<spring:url value="/User/feedback"/>' enctype="multipart/form-data">
					<div class="row form-group">
						<div class="col-md-4">
							<label class="col control-label text-center" for="vehical_no">
								Name</label>
							<div class="input-group">
								<i class="glyphicon glyphicon-user"></i> <input name="name"
						...
						<div class="col-lg-4">
							<label class="col control-label text-center" for="vehical_type">
								Feedback </label>
							<div class="input-group">
								<textarea name="feedback" class="form-control text-center"
									type="text"></textarea>
							</div>
						</div>
						...
						<div class="col-lg-4">
							<label class="col control-label text-center"
								for="vehical_company"> Rating </label>
							<div class="input-group">
								<input class="form-control text-center" type="int" name="rating" />
							</div>
						</div>
					</div>
