...
<body>
	...
	<div class="wrapper">
		...
		<form class="form-right" action='<spring:url value="/User/pay"/>'
			method="post">
			<h2 class="text-uppercase">Payment Process</h2>
			<h2 style="color: red">${requestScope.message}</h2>
			<div class="row">
				<div class="col-sm-6 mb-3">
					<label>Card No</label> <input type="text" name="card"
						class="input-field" Required>
				</div>

			</div>
			<div class="mb-3">
				<label>Exp Date(MM/YY)</label> <input type="text" class="input-field"
					name="date" required>
			</div>
			<div class="mb-3 col col-2">
				<label>CVV</label> <input type="number" class="input-field"
					name="cvv" required>
			</div>
			<div class="mb-3 col col-2">
				<label>Card Holder Name</label> <input type="Text"
					class="input-field" name="name" required>
			</div>
